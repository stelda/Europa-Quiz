...
var CUISINE = [
  ...
  { dish: "Bitterballen",     country: "Pays-Bas",  fact: "Boulettes de viande panées et frites, servies avec de la moutarde." },
  { dish: "Judd mat Gaardebounen", country: "Luxembourg", fact: "Collier de porc fumé avec des fèves, plat national luxembourgeois." },
  { dish: "Ćevapi",           country: "Croatie",   fact: "Petites saucisses grillées de viande hachée, servies dans du pain plat." },
  { dish: "Sarmale",          country: "Roumanie",  fact: "Feuilles de chou farcies de viande et de riz, plat traditionnel de fête." },
  { dish: "Banitsa",          country: "Bulgarie",  fact: "Feuilleté au fromage blanc et aux œufs, mangé au petit-déjeuner." },
  { dish: "Trdelník",         country: "Tchéquie",  fact: "Pâtisserie en forme de cylindre, cuite sur un rouleau et roulée dans le sucre." },
  { dish: "Bryndzové halušky",country: "Slovaquie", fact: "Gnocchis de pommes de terre avec du fromage de brebis et du lard, plat national." },
  { dish: "Potica",           country: "Slovénie",  fact: "Gâteau roulé aux noix, tradition de Noël et de Pâques." },
  { dish: "Verivorst",        country: "Estonie",   fact: "Boudin noir traditionnel, servi surtout à Noël avec de la confiture d'airelles." },
  { dish: "Pelēkie zirņi",        country: "Lettonie", fact: "Pois gris au lard fumé et oignons, plat national letton servi à Noël et toute l'année." },
  { dish: "Cepelinai",        country: "Lituanie",  fact: "Gros raviolis de pommes de terre farcis de viande, en forme de zeppelin." },
  { dish: "Pastizzi",         country: "Malte",     fact: "Feuilletés fourrés à la ricotta ou aux petits pois, snack national." },
  { dish: "Halloumi",         country: "Chypre",    fact: "Fromage grillé à base de lait de chèvre et de brebis, spécialité chypriote." },
  { dish: "Karjalanpiirakka", country: "Finlande",  fact: "Petite tourte carelienne au riz, servie avec du beurre aux œufs." },
  { dish: "Bruschetta",      country: "Italie",    fact: "Tartine de pain grillé avec tomates, ail, basilic et huile d'olive." },
  { dish: "Tiramisu",         country: "Italie",    fact: "Dessert au café, mascarpone et cacao, inventé dans les années 1960." },
  { dish: "Pâtes à la carbonara", country: "Italie", fact: "Pâtes avec œuf, fromage pecorino et guanciale, spécialité de Rome." },
  { dish: "Crêpes",           country: "France",    fact: "Galette fine sucrée ou salée, originaire de Bretagne." },
  { dish: "Baguette",         country: "France",    fact: "Pain long et croustillant, symbole de la France dans le monde entier." },
  { dish: "Churros",          country: "Espagne",   fact: "Beignets allongés frits, souvent trempés dans du chocolat chaud." },
  { dish: "Pretzel",          country: "Allemagne", fact: "Pain salé en forme de nœud, aussi appelé Bretzel, très populaire en Bavière." },
  { dish: "Feta",             country: "Grèce",     fact: "Fromage blanc de brebis utilisé dans la salade grecque, protégé par une appellation." },
  { dish: "Stroopwafel",      country: "Pays-Bas",  fact: "Gaufre fine fourrée au caramel, spécialité de Gouda." },
  { dish: "Strudel aux pommes", country: "Autriche", fact: "Pâtisserie feuilletée fourrée aux pommes, cannelle et raisins secs." },
  { dish: "Chocolat",         country: "Belgique",  fact: "La Belgique est célèbre pour ses pralines et ses chocolatiers artisanaux." },
  { dish: "Gazpacho",         country: "Espagne",   fact: "Soupe froide de tomates, poivrons et concombre, typique de l'Andalousie." },
];
...
var CUISINE_EN = [
  ...
  { dish: "Bitterballen",     country: "Netherlands", fact: "Deep-fried breaded meat balls, served with mustard." },
  { dish: "Judd mat Gaardebounen", country: "Luxembourg", fact: "Smoked pork collar with broad beans, Luxembourg's national dish." },
  { dish: "Ćevapi",           country: "Croatia",     fact: "Small grilled minced meat sausages, served in flatbread." },
  { dish: "Sarmale",          country: "Romania",     fact: "Cabbage rolls stuffed with meat and rice, a festive tradition." },
  { dish: "Banitsa",          country: "Bulgaria",    fact: "Pastry with white cheese and eggs, eaten for breakfast." },
  { dish: "Trdelník",         country: "Czechia",     fact: "Cylinder-shaped pastry cooked on a roller and coated in sugar." },
  { dish: "Bryndzové halušky",country: "Slovakia",    fact: "Potato dumplings with sheep cheese and bacon, national dish." },
  { dish: "Potica",           country: "Slovenia",    fact: "Walnut roll cake, a Christmas and Easter tradition." },
  { dish: "Verivorst",        country: "Estonia",     fact: "Traditional blood sausage, mainly served at Christmas with lingonberry jam." },
  { dish: "Pelēkie zirņi",        country: "Latvia",  fact: "Grey peas with smoked bacon and onions, Latvian national dish served at Christmas and year-round." },
  { dish: "Cepelinai",        country: "Lithuania",   fact: "Large potato dumplings stuffed with meat, shaped like zeppelins." },
  { dish: "Pastizzi",         country: "Malta",       fact: "Flaky pastries filled with ricotta or peas, the national snack." },
  { dish: "Halloumi",         country: "Cyprus",      fact: "Grilled cheese made from goat and sheep milk, Cypriot specialty." },
  { dish: "Karelian pie",     country: "Finland",     fact: "Small rice-filled pastry, served with egg butter." },
  { dish: "Bruschetta",      country: "Italy",       fact: "Toasted bread topped with tomatoes, garlic, basil and olive oil." },
  { dish: "Tiramisu",         country: "Italy",       fact: "Coffee and mascarpone dessert with cocoa, invented in the 1960s." },
  { dish: "Carbonara pasta",  country: "Italy",       fact: "Pasta with egg, pecorino cheese and guanciale, a Roman specialty." },
  { dish: "Crêpes",           country: "France",      fact: "Thin pancakes, sweet or savoury, originally from Brittany." },
  { dish: "Baguette",         country: "France",      fact: "Long crusty bread, a symbol of France worldwide." },
  { dish: "Churros",          country: "Spain",       fact: "Fried dough sticks, often dipped in hot chocolate." },
  { dish: "Pretzel",          country: "Germany",     fact: "Knot-shaped salted bread, also called Bretzel, very popular in Bavaria." },
  { dish: "Feta",             country: "Greece",      fact: "White sheep's milk cheese used in Greek salad, with protected designation." },
  { dish: "Stroopwafel",      country: "Netherlands", fact: "Thin waffle filled with caramel syrup, a specialty from Gouda." },
  { dish: "Apple strudel",    country: "Austria",     fact: "Flaky pastry filled with apples, cinnamon and raisins." },
  { dish: "Chocolate",        country: "Belgium",     fact: "Belgium is famous for its pralines and artisan chocolatiers." },
  { dish: "Gazpacho",         country: "Spain",       fact: "Cold tomato soup with peppers and cucumber, typical of Andalusia." },
];
